...
@Api(name = "pratosendpoint", namespace = @ApiNamespace(ownerDomain = "boteco.comida", ownerName = "boteco.comida", packagePath = "server"))
public class PratosEndpoint {
	...
	public CollectionResponse<Pratos> listPratos(
		...
		return CollectionResponse.<Pratos> builder().setItems(execute)
